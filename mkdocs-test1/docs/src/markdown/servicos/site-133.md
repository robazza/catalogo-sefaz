---
title: "Carta de Anuência e consultar seus débitos"
descricao: |
 Consiste em emitir a carta que corresponde ao protesto referente ao débito tributário
legislação: 
 - 'Lei nº 7.186 de 2006'
prazo: Pronto Atendimento
custo: sem custo
documentacao: 
 - 'CPF ou CNPJ ou inscrição Mobiliária ou Inscrição Imobiliária ou nº do AI/NFL/RDT'
responsavel:
  coordenacao: CRC
  setor: SEATE
